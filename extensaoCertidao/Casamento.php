...
class Casamento extends Certidao
{
    ...
    protected $dtCasamento;
    protected $pessoa;



    public function __construct($nrRegistroCertidao,pessoa $pessoa,$nomedoDeclarante, $tipoCertidao, $dtEmissao, $nomeTabeliao,$nomeCartorio ,$dtCasamento)
    {
